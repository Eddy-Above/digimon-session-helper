...
onMounted(async () => {
  await Promise.all([fetchEvolutionLines(undefined, campaignId.value), fetchTamers(campaignId.value)])
})
...
<template>
  <div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
      ...
      <NuxtLink
        :to="`/campaigns/${campaignId}/library/evolution/new`"
    ...
    <div v-else class="grid gap-4">
      <NuxtLink
        ...
        :key="line.id"
        :to="`/campaigns/${campaignId}/library/evolution/${line.id}`"
